...
const formEndpoint =
  "https://public.herotofu.com/v1/5e6a9170-b4eb-11ed-a036-a589518453bd";
    ...
    <div className="overlayScreen font-mono">
      ...
      <footer className="text-center font-bold mx-40">
        ...
        <ul className="flex flex-row justify-around mt-4 text-2xl">
          <li>
            <a
              className="text-white border-2 border-black bg-black bg-opacity-70 rounded-xl p-2 hover:bg-opacity-60 hover:border-gray-400"
          ...
          <li>
            <a
              className="text-white border-2 border-black bg-black bg-opacity-70 rounded-xl p-2 hover:bg-opacity-60 hover:border-gray-400"
              href="mailto:brandonkly@ucla.edu"
              target="_blank"
            >
              Email
            </a>
